...
흑백 문양 이미지 한 장과 그 이미지에 대한 설명 문장을 함께 받아, 22개 감성 라벨 중 5개를 고릅니다. 정답도 항상 5개이므로 precision = recall = F1 이고, 지표는 F1@5 입니다.
...
|---|---|
| 이미지 | 흑백 선화 문양 이미지 파일 |
| `description` | 작업자가 쓴 자유 서술 문장. 학습에 쓰는 유일한 텍스트 입력 |
| 감성 라벨 | 22개 어휘 중 5개 |
